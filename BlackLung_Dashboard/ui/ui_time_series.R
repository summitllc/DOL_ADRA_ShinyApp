...
tab_time_series <- tabItem(tabName = "time_series",
                           ...
                           box(title = strong(("How has the mining environment changed over the years?")), status = "success", width = 12,
                             ...
                             fluidRow(
                               column(6,
                                      billboarderOutput(outputId = "total_mine_time")#, hover = hoverOpts("total_mine_time_hover")),
